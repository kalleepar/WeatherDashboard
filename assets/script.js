$(document).ready(function () {
    ...
    function weatherFunction(searchTerm) {
      ...
      $.ajax({
        type: "GET",
        url: "https://api.openweathermap.org/data/2.5/weather?q=" + searchTerm + "&appid=e266aca67d430fa6fd4cca475c0b8a4a",
        ...
        $.ajax({
          type: "GET",
          url: "https://api.openweathermap.org/data/2.5/uvi?appid=e266aca67d430fa6fd4cca475c0b8a4a&lat=" + lat + "&lon=" + lon,
